...
function AgentGuard({ mintedAsset }) {
  ...
  return (
    <div className="mt-8 pt-8 border-t border-slate-700">
      <h2 className="text-2xl font-bold text-center text-cyan-500 mb-4">Agent Guard</h2>
      <div className="max-w-md mx-auto bg-slate-800 p-4 rounded-lg">
        <div className="flex space-x-2">
          ...
          />
          <button onClick={checkTopic} className="bg-cyan-500 px-4 py-2 rounded-lg hover:bg-cyan-600">
            Ask
          </button>
        </div>
        {response && (
